...
def test_shared_directories_good_value_updates_config(monkeypatch):
...
def test_shared_directories_good_value_false_keeps_config(monkeypatch):
...
def test_shared_directories_bad_value_shows_error(monkeypatch):
    set_confirm_update(monkeypatch)
    custom_shared_directories = get_custom_shared_directories()
    output = get_command_output(
        [
...
def test_pickle_file_good_value_updates_config(monkeypatch):
    set_confirm_update(monkeypatch)
...
def test_pickle_file_good_value_false_keeps_config(monkeypatch):
    set_confirm_update(monkeypatch, yes=False)
    custom_pickle_file = get_custom_pickle_file()
    custom_pickle_file.touch()
    default_output = get_command_output([config_command, "file-system"])
...
def test_pickle_file_bad_value_shows_error(monkeypatch):
    set_confirm_update(monkeypatch)
    custom_pickle_file = get_custom_pickle_file()
    output = get_command_output(
        [
...
def test_ignored_directories_good_value_updates_config(monkeypatch):
    set_confirm_update(monkeypatch)
...
def test_ignored_directories_good_value_false_keeps_config(monkeypatch):
    set_confirm_update(monkeypatch, yes=False)
    custom_ignored_directories = get_custom_ignored_directories()
    Path.mkdir(custom_ignored_directories)
    default_output = get_command_output([config_command, "file-system"])
...
def test_ignored_directories_bad_value_shows_error(monkeypatch):
    set_confirm_update(monkeypatch)
    custom_ignored_directories = get_custom_ignored_directories()
    output = get_command_output(
        [
